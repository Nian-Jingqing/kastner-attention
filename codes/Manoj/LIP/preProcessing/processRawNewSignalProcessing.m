%% get rid of matlab warning message printing
w_id = 'finance:ftseries:tsmovavg:FunctionToBeRemoved';
warning('off',w_id)

%%
baseDir = '/mnt/scratch/feng/LIP'; % where raw data is stored on Cortex
%baseDir = '/home/fzhu23/LIP';

%% First cohort of sessions Manoj sent
...
%% Second cohort of sessions Manoj sent
...
%% Third cohort of sessions Manoj sent
...
%% Fourth cohort of sessions Manoj sent
...
%outDir_old = '/snel/share/share/data/kastner/Manoj/LIP/spikeBand/notchFilt_bandPass/tmp1/'; %previous path to store processed data without notch filtering

%%
poolobj = gcp('nocreate');
delete( poolobj )
parpool( 20 ) % for Running on Cortex
%parpool( 20 ) % for running on Striate
