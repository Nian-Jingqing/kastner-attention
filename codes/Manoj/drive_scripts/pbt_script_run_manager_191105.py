...
svr.add_hp('l2_gen_scale', (1e-5, 0.1), init_sample_mode='logrand', explore_param = 0.6, explorable=True)
svr.add_hp('l2_ic_enc_scale', [0.0], init_sample_mode=[0.0], explorable=False)

svr.add_hp('l2_con_scale', (1e-5, 0.1), init_sample_mode='logrand',  explorable=True)
...
svr.add_hp('kl_ic_weight', (1e-7, 1e-4), init_sample_mode='logrand', explore_param = 0.3, explorable=True)
