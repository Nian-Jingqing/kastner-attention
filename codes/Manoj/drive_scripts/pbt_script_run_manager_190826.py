...
svr = Server(name, run_save_path, num_workers=28, steps_to_ready=10,
...
svr.add_hp('l2_gen_scale', (1e-5, 0.1), init_sample_mode='logrand', explore_param = 0.8, explorable=True)
...
svr.add_hp('kl_co_weight', (1e-6, 1e-4), init_sample_mode='logrand', explore_param = 0.3, explorable=True)
svr.add_hp('kl_ic_weight', (1e-5, 1e-3), init_sample_mode='logrand', explore_param = 0.3, explorable=True)
