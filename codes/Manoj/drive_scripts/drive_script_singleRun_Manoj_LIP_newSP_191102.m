...
datasetPath = '/snel/share/share/derived/kastner/data_processed/ManojData/singleArea/LIP/thresholdCrossings/newSignalProcessing/withPreAligned_noExtInp/';
dc = Pulvinar.DatasetCollection(datasetPath);
dc.name = '10-days-goodChannels';

% add individual datasets
% add individual datasets
Pulvinar.Dataset(dc, '02082019_v1.mat');
Pulvinar.Dataset(dc, '02132019_v1.mat');
Pulvinar.Dataset(dc, '02142019_v1.mat');
Pulvinar.Dataset(dc, '02152019_v1.mat');
Pulvinar.Dataset(dc, '02182019_v1.mat');
Pulvinar.Dataset(dc, '02262019_v1.mat');
Pulvinar.Dataset(dc, '02282019_v1.mat');
Pulvinar.Dataset(dc, '03032019_v1.mat');
Pulvinar.Dataset(dc, '03062019_v1.mat');
Pulvinar.Dataset(dc, '03142019_v1.mat');
...
par.c_co_dim = 6; % number of units in controller
...
par.c_ic_dim = 64;
par.c_l2_gen_scale = 1e-6;
par.c_l2_con_scale = 1e-5;
par.c_kl_ic_weight = 1e-5;
par.c_kl_co_weight = 1e-7;
...
%par.doPBT = true;
%par.PBTscript = '/snel/home/fzhu23/Projects/Pulvinar/old_pulvinarRepo/Kastner_Attention/codes/Manoj/drive_scripts/pbt_script_run_manager_191101.py';
