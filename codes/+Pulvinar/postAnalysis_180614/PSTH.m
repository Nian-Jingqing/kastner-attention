...
%% get timing info
loadpath = ['/snel/share/share/data/kastner/pulvinar/multi-unit/preAligned/data_raw/MarToJun/v10/M20170308/Gratings/M20170308_PUL_63M-g2-g3-g4-g5-g6-g7-g8-evokedSpiking-v10.mat'];
data = load(loadpath);
UE = data.UE;
clear data
...
savedirOne = '/snel/share/share/derived/kastner/LFADS_runs/pulvinar/Multi-day/multiDay_CO_AO_TD_HoldRel_JanToApr/postAnalysis/withExternalInput_20180614/PSTH/committeeMeetingVersion/1';

%cd(savedirOne);
clear set
plottingPSTHs(AvgFiringRate_InRF_cue_real,AvgFiringRate_OffRF_cue_real, SmoothedSpikingMatrix_cue_real, AvgFiringRate_InRF_cue_lfads,AvgFiringRate_OffRF_cue_lfads, SmoothedSpikingMatrix_cue_lfads, TrialIndexInRF_cue_real, TrialIndexOffRF_cue_real, nTimesLFADS, 'cueOnset', nIndices, savedirOne  )
