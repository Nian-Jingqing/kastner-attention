...
svr = Server(name, run_save_path, num_workers=32, steps_to_ready=5,
             ...
             explore_method='perturb', explore_param=0.8, mode='minimize', force_overwrite=True, percent_change_to_stop=0.0, mongo_server_ip='localhost', port=27017, server_log_path=run_save_path, num_no_best_to_stop=15)
...
svr.add_hp('l2_gen_scale', (1e-4, 1), init_sample_mode='logrand', explore_param = 1.2, explorable=True)
svr.add_hp('l2_ic_enc_scale', [0.0], init_sample_mode=[0.0], explorable=False)

svr.add_hp('l2_con_scale', (1e-4, 1), init_sample_mode='logrand', explore_param = 1.2, explorable=True)
