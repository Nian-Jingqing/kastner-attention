...
#         'ip': '192.168.1.200',
#         'max_processes': 6,
#         'process_start_cmd': '/snel/home/fzhu23/bin/PBT_HP_opt/pbt_opt/run_lfads_clien#t.sh',
#         'wait_for_process_start':False,
#    },
]
...
svr = Server(name, run_save_path, num_workers=42, steps_to_ready=20,
...
svr.add_hp('keep_ratio', (0.01, 0.99999), init_sample_mode=[0.5], limit_explore=True, explore_param=0.3, explorable=True) # for run 180614, for sample validation
