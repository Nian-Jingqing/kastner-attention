...
svr = Server(name, run_save_path, num_workers=54, steps_to_ready=40,
             max_generations=150, exploit_method='binarytournament', exploit_param=[],
             explore_method='perturb', explore_param=0.8, mode='minimize', force_overwrite=True, percent_change_to_stop=0.0, mongo_server_ip='localhost', port=27017, server_log_path=run_save_path, num_no_best_to_stop=10)
...
svr.add_hp('l2_gen_scale', (1e-11, 1e-6), init_sample_mode='logrand', explore_param = 0.8, explorable=True)
...
svr.add_hp('kl_co_weight', (5e-8, 5e-6), init_sample_mode='logrand', explore_param = 0.3, explorable=True)
