...
svr = Server(name, run_save_path, num_workers=34, steps_to_ready=40,
             ...
             explore_method='perturb', explore_param=0.8, mode='minimize', force_overwrite=True, percent_change_to_stop=0.0, mongo_server_ip='localhost', port=27017, server_log_path=run_save_path, num_no_best_to_stop=5)
...
svr.add_hp('kl_co_weight', (1e-6, 5e-5), init_sample_mode='logrand', explore_param = 0.3, explorable=True)
