...
svr.add_hp('l2_gen_scale', (0.1, 5000), init_sample_mode='logrand', explorable=True)
svr.add_hp('l2_ic_enc_scale', (0.1, 5000), init_sample_mode='logrand', explorable=True)

svr.add_hp('l2_con_scale', (0.1, 5000), init_sample_mode='logrand', explorable=True)
...
svr.add_hp('kl_ic_weight', (0.1, 5), init_sample_mode='logrand', explore_param=0.3, explorable=True)
