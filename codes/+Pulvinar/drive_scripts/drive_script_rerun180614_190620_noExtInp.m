...
rc2 = Pulvinar.RunCollection(runRoot, 'reRun180614_20190620_noExtInp_191112', dc);

% replace this with the date this script was authored as YYYYMMDD 
% This ensures that updates to lfads-run-manager won't invalidate older 
% runs already on disk and provides for backwards compatibility
rc2.version = 201906201;
...
par.c_inject_ext_input_to_gen = false;
par.c_keep_ratio = 1;

% the following params make sure this is a pbt run
par.doPBT = true;
par.PBTscript = '/snel/home/fzhu23/Projects/Pulvinar/old_pulvinarRepo/Kastner_Attention/codes/+Pulvinar/drive_scripts/pbt_script_run_manager_191112.py';
