...
runRoot = ['/snel/share/share/derived/kastner/model_interaction/runs/test_refactored_190719/'];
rc2 = Pulvinar.RunCollection(runRoot, 'singleDay_pul', dc);

% replace this with the date this script was authored as YYYYMMDD 
% This ensures that updates to lfads-run-manager won't invalidate older 
% runs already on disk and provides for backwards compatibility
rc2.version = 20190719;
...
par.spikeBinMs = 4;
par.c_batch_size = 40; % must be < 1/5 of the min trial count
par.trainToTestRatio = 5;
...
par.c_ext_input_rnn_dim = 64;
par.c_keep_ratio = 1;

% the following params make sure this is a pbt run
%par.doPBT = true;
%par.PBTscript = '/snel/home/fzhu23/Projects/Pulvinar/old_pulvinarRepo/Kastner_Attention/codes/+Pulvinar/drive_scripts/pbt_script_run_manager_190620.py';
