...
# KL costs
svr.add_hp('kl_co_weight', (0.1, 10), init_sample_mode='logrand', explore_param=0.3, explorable=True)
svr.add_hp('kl_ic_weight', (0.1, 10), init_sample_mode='logrand', explore_param=0.3, explorable=True)
...
svr.add_hp('keep_ratio', (0.1, 0.999), init_sample_mode='rand', limit_explore=True, explore_param=0.3, explorable=True)
...
svr.add_hp('cd_grad_passthru_prob', (0.0, 0.999), init_sample_mode=[0.5], limit_explore=True,  explore_param=0.3, explorable=True)
...
svr.add_hp('factors_dim', [20], explorable=False)
svr.add_hp('in_factors_dim', [20])
...
svr.add_hp('batch_size', [150], explorable=False)
...
svr.add_hp('con_ci_enc_in_dim', [20], explorable=False)
svr.add_hp('con_fac_in_dim', [20], explorable=False)
...
svr.add_hp('co_dim', [3], explorable=False)
