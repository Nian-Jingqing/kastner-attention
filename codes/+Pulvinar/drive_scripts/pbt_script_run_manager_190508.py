...
svr = Server(name, run_save_path, num_workers=34, steps_to_ready=40,
             max_generations=70, exploit_method='binarytournament', exploit_param=[],
             explore_method='perturb', explore_param=0.8, mode='minimize', force_overwrite=True,
             mongo_server_ip='localhost', port=27017, server_log_path=run_save_path, num_no_best_to_stop=8)
...
# Learning rate
svr.add_hp('learning_rate_init', (0.00001, 0.01), init_sample_mode=[0.001],
...
# Coordinated Dropout
svr.add_hp('keep_ratio', (0.5, 0.99999), init_sample_mode='rand',
           explore_method='perturb', explore_param=0.3, limit_explore=True, explorable=True)
...
svr.add_hp('l2_gen_scale', (0.003, 10.0), init_sample_mode='logrand', explorable=True)
svr.add_hp('l2_ic_enc_scale', [0.0], init_sample_mode=[0.0], explorable=False)

svr.add_hp('l2_con_scale', (0.003, 10.0), init_sample_mode='logrand', explorable=True)
...
svr.add_hp('kl_co_weight', (1e-4, 5e-3), init_sample_mode='logrand', explore_param = 0.3, explorable=True)
svr.add_hp('kl_ic_weight', (1e-4, 5e-3), init_sample_mode='logrand', explore_param = 0.3, explorable=True)
...
svr.add_hp('cd_grad_passthru_prob', (0.0, 0.999), init_sample_mode=[0.5], limit_explore=True,  explore_param=0.3, explorable=True) # for run 180614, for sa
