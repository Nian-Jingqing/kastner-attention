...
svr = Server(name, run_save_path, num_workers=54, steps_to_ready=5,
...
svr.add_hp('l2_gen_scale', (1e-7, 1e-1), init_sample_mode='logrand', explore_param = 0.8, explorable=True)
