...
svr.add_hp('cd_grad_passthru_prob', (0.0, 0.999), init_sample_mode='rand', limit_explore=True,  explore_param=0.3, explorable=True)
...
svr.add_hp('batch_size', [200], explorable=False)
