...
svr = Server(name, run_save_path, num_workers=32, steps_to_ready=20,
             ...
             server_ip='localhost', port=27017, server_log_path=run_save_path, num_no_best_to_stop=3)
...
svr.add_hp('factors_dim', [25], explorable=False)
svr.add_hp('in_factors_dim', [25])
...
svr.add_hp('con_ci_enc_in_dim', [25], explorable=False)
svr.add_hp('con_fac_in_dim', [25], explorable=False)
