...
svr.add_hp('l2_gen_scale', (1e-5, 1e-2), init_sample_mode='logrand', explorable=True)
...
svr.add_hp('kl_co_weight', (1e-6, 1e-5), init_sample_mode='logrand', explore_param = 0.3, explorable=True)
