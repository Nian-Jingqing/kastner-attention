...
datasetPath = ['/snel/share/share/derived/kastner/data_processed/' ...
    'pulvinar/multi-unit/continuousOverlapChop/multiDay_JanToMar/'];
...
rc2 = Pulvinar.RunCollection(runRoot, 'withGoodNeurons_PBTRun_20180511', dc);

% replace this with the date this script was authored as YYYYMMDD 
% This ensures that updates to lfads-run-manager won't invalidate older 
% runs already on disk and provides for backwards compatibility
rc2.version = 20180511;
