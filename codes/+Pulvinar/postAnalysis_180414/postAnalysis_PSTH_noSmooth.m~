...
rc2 = Pulvinar.RunCollection(runRoot, 'withGoodNeurons_PBTRun_20180414', dc);
% replace this with the date this script was authored as YYYYMMDD 
% This ensures that updates to lfads-run-manager won't invalidate older 
% runs already on disk and provides for backwards compatibility
rc2.version = 20180414;
...
par4( 1 ).trainToTestRatio = 7;
par4( 1 ).c_batch_size = 100;
...
recValid = cellfun( @(x) str2num(x), log(:, 11));
semilogy(recTrain);
hold on
semilogy(recValid);
legend('Train','Valid')
...
savedirOne = ['/snel/share/share/derived/kastner/LFADS_runs/pulvinar/Multi-day/multiDay_CO_AO_TD_HoldRel_JanToApr/' ...
    'postAnalysis/withGoodNeurons_PBTRun_20180414/PSTH/NoSmoothing/cueOnset/170127/'];
