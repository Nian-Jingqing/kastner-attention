...
rc = Pulvinar.RunCollection(runRoot, 'withGoodNeurons_Run_20180129', dc);
...
% neuronID = {'2a', '5b', '7b','9a', '15a', '19a', '19b', '20a', '21c', '24a', '28a', '29a', '35a', '37a', '42a', '43a', '43c', '44a', '47a', '48a', '49a', '51a', '53a', '54a', '55a', '57a', '59a', '61a', '62a'};
...
savedirOne = ['/snel/share/share/derived/kastner/LFADS_runs/pulvinar/M20170608_PUL_all-g2-g3-g4-evokedSpiking-v7/' ...
    'CueOnArrayOnTargetDim_HoldRel/postAnalysis/withGoodNeurons_Run_20180129/PSTH/Gaussian50ms/cueOnset/Ryan_100/'];
