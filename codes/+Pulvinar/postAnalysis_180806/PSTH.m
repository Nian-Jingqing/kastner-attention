...
par.spikeBinMs = 4;
par.c_batch_size = 1; % must be < 1/5 of the min trial count
par.trainToTestRatio = 290;
...
par.doPBT = true;
par.PBTscript = '/snel/home/fzhu23/Projects/Pulvinar/codes/+Pulvinar/drive_scripts/pbt_script_run_manager_180806.py';
...
savedirOne = ['/snel/share/share/derived/kastner/LFADS_runs/pulvinar/Multi-day/multiDay_CO_AO_TD_HoldRel_JanToApr/postAnalysis/withExternalInput_20180806/PSTH/NoSmoothing/cueOnset/170127/'];


%cd(savedirOne);
clear set
plottingPSTHs(AvgFiringRate_InRF_cue_real,AvgFiringRate_OffRF_cue_real, SmoothedSpikingMatrix_cue_real, AvgFiringRate_InRF_cue_lfads,AvgFiringRate_OffRF_cue_lfads, SmoothedSpikingMatrix_cue_lfads, TrialIndexInRF_cue_real, TrialIndexOffRF_acue_real, nTimesLFADS, 'cueOnset', nIndices, savedirOne  )
