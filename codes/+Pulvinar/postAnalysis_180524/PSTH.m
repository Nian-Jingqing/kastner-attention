...
r_id = 1;
run = rc2.runs(r_id);
r_lfads = olapChopped.r.get_output_from_lfads(run, trial_time_ms, trial_olap_ms);
...
savedirOne = ['/snel/share/share/derived/kastner/LFADS_runs/pulvinar/Multi-day/multiDay_CO_AO_TD_HoldRel_JanToApr/' ...
    'postAnalysis/withExternalInput_20180524/normalLFADS/PSTH/NoSmoothing/targetDim/170127/'];
