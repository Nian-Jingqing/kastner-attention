...
r_lfadsWhole = RunID(6).r_lfads(6).copy();
...
savedirOne = ['/snel/share/share/derived/kastner/LFADS_runs/pulvinar/Multi-day/multiDay_CO_AO_TD_HoldRel_JanToMar/postAnalysis/' ...
    'withGoodNeurons_Run_20180216/PSTH/run6/Gaussian10ms/targetDim/170311'];
...
%     set(gca,'XTickLabels',{'-800','TargetDim','+800'}); 
    set(gca,'XTickLabels',{'-750','TargetDim','+750'});
