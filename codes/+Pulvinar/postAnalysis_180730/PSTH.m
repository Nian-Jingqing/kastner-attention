...
par.doPBT = true;
par.PBTscript = '/snel/home/fzhu23/Projects/Pulvinar/codes/+Pulvinar/drive_scripts/pbt_script_run_manager_180730.py';
...
savedirOne = ['/snel/share/share/derived/kastner/LFADS_runs/pulvinar/Multi-day/multiDay_CO_AO_TD_HoldRel_JanToApr/' ...
    'postAnalysis/withExternalInput_20180730/PSTH/NoSmoothing/targetDim/170127/'];


%cd(savedirOne);
clear set
plottingPSTHs(AvgFiringRate_InRF_array_real,AvgFiringRate_OffRF_array_real, SmoothedSpikingMatrix_array_real, AvgFiringRate_InRF_array_lfads,AvgFiringRate_OffRF_array_lfads, SmoothedSpikingMatrix_array_lfads, TrialIndexInRF_array_real, TrialIndexOffRF_array_real, nTimesLFADS, 'arrayOnset', nIndices, savedirOne  )
