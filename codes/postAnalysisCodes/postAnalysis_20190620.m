...
%% save alf
%% save
saveDataDir = '/snel/home/fzhu23/Projects/Pulvinar/old_pulvinarRepo/Kastner_Attention/codes/timeWarping/';
cd(saveDataDir);
saveName = ['spikes_rates_190620'];
save(saveName, 'alf');

%%
savedirOne = '/snel/share/share/derived/kastner/LFADS_runs/pulvinar/Multi-day/multiDay_CO_AO_TD_HoldRel_JanToApr/postAnalysis/reRun180614_20190620/PSTH/arrayOnset/170308';
if ~isdir( savedirOne )
    mkdir( savedirOne );
end

savedirTwo = '/snel/share/share/derived/kastner/LFADS_runs/pulvinar/Multi-day/multiDay_CO_AO_TD_HoldRel_JanToApr/postAnalysis/reRun180614_20190620/PSTH/cueOnset/170308';
if ~isdir( savedirTwo )
    mkdir( savedirTwo );
end
