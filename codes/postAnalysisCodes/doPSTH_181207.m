...
loadpath = ['/snel/share/share/derived/kastner/data_processed/pulvinar/' ...
    'multi-unit/continuousOverlapChop/multiDay_JanToMar/withExternalInput_withLag/twoLoc_bigN/170311_cueOnArrayOnTargetDim_HoldRel.mat'];
...
%% get timing info
loadpath = ['/snel/share/share/data/kastner/pulvinar/multi-unit/preAligned/data_raw/MarToJun/v10/M20170311/Gratings/M20170311_PUL_9M-g3-g4-g6-g7-g8-g9-evokedSpiking-v10.mat'];
data = load(loadpath);
UE = data.UE;
clear data
...
[AvgFiringRate_InRF_cue_real,AvgFiringRate_OffRF_cue_real, SmoothedSpikingMatrix_cue_real, TrialIndexInRF_cue_real, TrialIndexOffRF_cue_real, nTimesLFADS] = computeFRForPSTH(assembled_real, 'cueAlign', ...
                                                  sigma, binsize, olapChopped.r.r, 'real', 'smooth');
[AvgFiringRate_InRF_array_real,AvgFiringRate_OffRF_array_real, SmoothedSpikingMatrix_array_real, TrialIndexInRF_array_real, TrialIndexOffRF_array_real, nTimesLFADS] = computeFRForPSTH(assembled_hold_real, ...
                                                  'arrayAlign', sigma, binsize, olapChopped_hold, 'real', 'smooth');
[AvgFiringRate_InRF_dim_real,AvgFiringRate_OffRF_dim_real, SmoothedSpikingMatrix_dim_real, TrialIndexInRF_dim_real, TrialIndexOffRF_dim_real, nTimesLFADS] = computeFRForPSTH(assembled_hold_real, ...
...
[AvgFiringRate_InRF_array_lfads,AvgFiringRate_OffRF_array_lfads, SmoothedSpikingMatrix_array_lfads, TrialIndexInRF_array_lfads, TrialIndexOffRF_array_lfads, nTimesLFADS] = computeFRForPSTH(assembled_hold_lfads, ...
                                                  'arrayAlign', sigma, binsize, olapChopped_hold, 'lfads', 'raw');
[AvgFiringRate_InRF_dim_lfads,AvgFiringRate_OffRF_dim_lfads, SmoothedSpikingMatrix_dim_lfads, TrialIndexInRF_dim_lfads, TrialIndexOffRF_dim_lfads, nTimesLFADS] = computeFRForPSTH(assembled_hold_lfads, ...
...
savedirOne = '/snel/share/share/derived/kastner/LFADS_runs/pulvinar/Multi-day/multiDay_CO_AO_TD_HoldRel_JanToApr/postAnalysis/withExternalInput_20181207/PSTH/arrayOnset/170311';
if ~isdir( savedirOne )
    mkdir( savedirOne );
end
...
%cd(savedirOne);
clear set
plottingPSTHs(AvgFiringRate_InRF_array_real,AvgFiringRate_OffRF_array_real, SmoothedSpikingMatrix_array_real, AvgFiringRate_InRF_array_lfads,AvgFiringRate_OffRF_array_lfads, SmoothedSpikingMatrix_array_lfads, ...
              TrialIndexInRF_array_real, TrialIndexOffRF_array_real, nTimesLFADS, 'arrayOnset', nIndices, savedirOne, 3/10, '-300ms', '+700ms'  )

savedirTwo = '/snel/share/share/derived/kastner/LFADS_runs/pulvinar/Multi-day/multiDay_CO_AO_TD_HoldRel_JanToApr/postAnalysis/withExternalInput_20181207/PSTH/cueOnset/170311';
if ~isdir( savedirTwo )
    mkdir( savedirTwo );
end
