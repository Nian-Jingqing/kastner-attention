...
outdir = '/snel/share/share/derived/kastner/LFADS_runs/pulvinar/Multi-day/multiDay_CO_AO_TD_HoldRel_JanToApr/postAnalysis/withExternalInput_20190214/lowD_traj/cueOnset/';
if ~isdir( outdir )
    mkdir( outdir );
end
...
totalTrialsToKeep = sum( cellfun( @sum, trialsToKeep(3) ) );
