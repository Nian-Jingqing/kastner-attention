...
savedirOne = '/snel/share/share/derived/kastner/LFADS_runs/pulvinar/Multi-day/multiDay_CO_AO_TD_HoldRel_JanToApr/postAnalysis/withExternalInput_20180614/PSTH/SAND/arrayOnset/170311';
if ~isdir( savedirOne )
    mkdir( savedirOne );
end
...
savedirTwo = '/snel/share/share/derived/kastner/LFADS_runs/pulvinar/Multi-day/multiDay_CO_AO_TD_HoldRel_JanToApr/postAnalysis/withExternalInput_20180614/PSTH/SAND/cueOnset/170311';
if ~isdir( savedirTwo )
    mkdir( savedirTwo );
end
