...
savedirOne = '/snel/share/share/derived/kastner/LFADS_runs/pulvinar/Multi-day/multiDay_CO_AO_TD_HoldRel_JanToApr/postAnalysis/withExternalInput_20181128/PSTH/arrayOnset/170311';
if ~isdir( savedirOne )
    mkdir( savedirOne );
end
