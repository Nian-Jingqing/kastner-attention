...
[AvgFiringRate_InRF_cue_real,AvgFiringRate_OffRF_cue_real, SmoothedSpikingMatrix_cue_real, TrialIndexInRF_cue_real, TrialIndexOffRF_cue_real, nTimesLFADS] = computeFRForPSTH_1(assembled_real, 'cueAlign', ...
...
savedirTwo = '/snel/share/share/derived/kastner/LFADS_runs/pulvinar/Multi-day/multiDay_CO_AO_TD_HoldRel_JanToApr/postAnalysis/withExternalInput_20190214/PSTH/cueOnset/170127';
if ~isdir( savedirTwo )
    mkdir( savedirTwo );
end
