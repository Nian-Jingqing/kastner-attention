...
loadpath = ['/snel/share/share/derived/kastner/data_processed/ManojData/singleArea/pulvinar/multi-unit/continuous/withExternalInput_withLag/tc/'];
...
for nday = 1:numel( datasets )
    ...
    fname = sprintf( '%s%s_v2.mat', loadpath, datasets( nday ).shortName );
    tmp = load( fname );
