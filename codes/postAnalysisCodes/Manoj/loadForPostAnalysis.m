...
loadpath = ['/snel/share/share/derived/kastner/data_processed/ManojData/singleArea/pulvinar/multi-unit/continuous/withExternalInput_withLag/testDay_020819/'];
...
if overWriteRealOrNot
    for nday = 1: numel( datasets )
        ...
        if smoothOrNot
            ...
            rbinned_real = assembled_real2.binData({'spike_smoothed'}, [1]);
        else
            rbinned_real = assembled_real2.binData({'spikes'}, [1]);
        end
