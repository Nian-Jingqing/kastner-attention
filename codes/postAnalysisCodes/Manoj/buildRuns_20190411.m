...
datasetPath = ['/snel/share/share/derived/kastner/data_processed/ManojData/singleArea/pulvinar/multi-unit/continuous/withExternalInput_withLag/tc/'];
dc = Pulvinar.DatasetCollection(datasetPath);
dc.name = 'multi-Days';

% add individual datasets
% add individual datasets
Pulvinar.Dataset(dc, '020819_v2.mat');
Pulvinar.Dataset(dc, '021819_v2.mat');
Pulvinar.Dataset(dc, '022619_v2.mat');
Pulvinar.Dataset(dc, '022719_v2.mat');
Pulvinar.Dataset(dc, '030819_v2.mat');
Pulvinar.Dataset(dc, '031019_v2.mat');
Pulvinar.Dataset(dc, '031119_v2.mat');
...
runRoot = ['/snel/share/share/derived/kastner/LFADS_runs/Manoj/pulvinar/180208/runs'];
rc2 = Pulvinar.RunCollection(runRoot, 'withExternalInput_20190411', dc);

% replace this with the date this script was authored as YYYYMMDD 
% This ensures that updates to lfads-run-manager won't invalidate older 
% runs already on disk and provides for backwards compatibility
rc2.version = 20190411;
...
par.doPBT = true;
par.PBTscript = '/snel/home/fzhu23/Projects/Pulvinar/codes/+Pulvinar/drive_scripts/Manoj/pbt_script_run_manager_190411.py';
