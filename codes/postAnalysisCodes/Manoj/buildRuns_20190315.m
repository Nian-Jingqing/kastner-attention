...
datasetPath = ['/snel/share/share/derived/kastner/data_processed/ManojData/singleArea/pulvinar/multi-unit/continuous/withExternalInput_withLag/'];
dc = Pulvinar.DatasetCollection(datasetPath);
dc.name = 'multi-Days';

% add individual datasets
% add individual datasets
Pulvinar.Dataset(dc, '020819_v1.mat');
Pulvinar.Dataset(dc, '021819_v1.mat');
Pulvinar.Dataset(dc, '022619_v1.mat');
Pulvinar.Dataset(dc, '022719_v1.mat');
Pulvinar.Dataset(dc, '030819_v1.mat');
Pulvinar.Dataset(dc, '031019_v1.mat');
Pulvinar.Dataset(dc, '031119_v1.mat');
...
par.doPBT = true;
par.PBTscript = '/snel/home/fzhu23/Projects/Pulvinar/codes/+Pulvinar/drive_scripts/Manoj/pbt_script_run_manager_190315.py';
