...
savedirOne = '/snel/share/share/derived/kastner/LFADS_runs/pulvinar/Multi-day/multiDay_CO_AO_TD_HoldRel_JanToApr/postAnalysis/reRun180614_20190508/PSTH/arrayOnset/170308';
if ~isdir( savedirOne )
    mkdir( savedirOne );
end
...
savedirTwo = '/snel/share/share/derived/kastner/LFADS_runs/pulvinar/Multi-day/multiDay_CO_AO_TD_HoldRel_JanToApr/postAnalysis/reRun180614_20190508/PSTH/cueOnset/170308';
if ~isdir( savedirTwo )
    mkdir( savedirTwo );
end
