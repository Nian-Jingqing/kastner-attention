...
%        John Cunningham  jcunnin@stanford.edu
  ...
  verbose      = false;
  freqLL       = 10;
  extra_opts   = GPFA.Util.assignopts(who, varargin);
  ...
  for i = 1:emMaxIters
    ...
    [seq, LLi] = GPFA.Core_GPFA.exactInferenceWithLL(seq, currentParams, 'getLL', getLL);    
    LL         = [LL LLi];
    ...
    if currentParams.notes.learnKernelParams
      res = GPFA.Core_GPFA.learnGPparams(seq, currentParams, 'verbose', verbose,... 
                                         extra_opts{:});
