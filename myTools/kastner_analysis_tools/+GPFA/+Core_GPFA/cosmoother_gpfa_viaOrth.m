...
%        John Cunningham  jcunnin@stanford.edu
  ...
  for i = 1:yDim    
    ...
    seqCs = GPFA.Core_GPFA.exactInferenceWithLL(seqCs, paramsCs, 'getLL', false);
    
    % Note: it is critical to use params.C here and not paramsCs.C 
    [Xorth, Corth]   = GPFA.Util.orthogonalize([seqCs.xsm], params.C);
    seqCs            = GPFA.Util.segmentByTrial(seqCs, Xorth, 'xorth');
