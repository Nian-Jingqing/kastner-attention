...
%        John Cunningham  jcunnin@stanford.edu
  ...
  switch params.covType
    case 'rbf'
      ...
      fname     = 'GPFA.Core_GPFA.grad_betgam';
    case 'tri'
      oldParams = params.a;
      fname     = 'GPFA.Core_GPFA.grad_trislope';
    case 'logexp'
      oldParams = params.a;
      fname     = 'GPFA.Core_GPFA.grad_logexpslope';
  end
  ...
  for i = 1:xDim
    ...
    GPFA.Util.minimize(initp, fname, MAXITERS, precomp(i), const);
