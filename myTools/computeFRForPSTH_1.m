function [AvgFiringRate_InRF,AvgFiringRate_OffRF, SmoothedSpikingMatrix, TrialIndexInRF, TrialIndexOffRF, nTimesLFADS] = computeFRForPSTH_1(assembled, infield, sigma, binsize, olapChopped, type, smoothOrNot)
